  ...
  <el-row class="row" style="padding: 0 10px 0 10px;margin-top: 5px">
    <el-row class="row" style="height: 35px;line-height: 35px">
      ...
      <el-button
        ...
        @click.native="importGroup"
        icon="el-icon-download"
      >导入分组</el-button>
      <el-dropdown trigger="hover" @command="quickTest">
        <div class="el-dropdown-link">
          <el-button class="btnMini" size="mini" type="primary" icon="fa fa-bolt" plain>快速测试</el-button>
        </div>
      ...
      <el-dropdown trigger="hover">
        <div class="el-dropdown-link">
          <el-button class="btnMini" size="mini" icon="fa fa-sort-amount-desc">排序</el-button>
        </div>
        <el-dropdown-menu slot="dropdown">
          <el-dropdown-item>
            <div @click="sortType=0">
              <i class="el-icon-check" style="color: #11b95c" v-if="sortType==0"></i>&nbsp;名称
            </div>
          </el-dropdown-item>
          <el-dropdown-item>
          ...
          <el-dropdown-item>
            <el-tooltip class="item" effect="dark" content="自定义排序下可以拖动接口或分组来排序" placement="right">
              <div @click="sortType=2">
                <i class="el-icon-check" style="color: #11b95c" v-if="sortType==2"></i>&nbsp;自定义
              </div>
            </el-tooltip>
          </el-dropdown-item>
        </el-dropdown-menu>
      ...
      <el-button
        ...
        title="放大/缩小"
        @click="$store.getters.event.$emit('toggleMax')"
      ></el-button>
    </el-row>
    <el-row class="row" style="height: calc(100% - 35px);">
      <el-col class="col" :span="bMax?0:6" style="padding-right: 5px;">
        <el-row
          class="row"
          style="background-color: white;padding: 5px;border-radius: 5px;height: calc(100vh - 211px);overflow-y: auto;margin-top: 5px"
        >
          <el-input
            size="small"
      ...
      <el-col
        ...
        class="col"
        id="interfaceContent"
        style="padding-top: 5px;height: calc(100vh - 209px)"
      >
        <el-tabs
          type="border-card"
        ...
        >
          <el-tab-pane
            ...
            :key="item"
          >
            <el-row class="row" slot="label" style="font-size: 13px">
              {{item.name}}&nbsp;
...
#interfaceContent .component-fade-enter-active,
